...
describe("polygonBounds", () => {
  ...
  it("calculates the bounds of a polygon", () => {
    const polygon = [[110, 40], [210, 10], [310, 40], [360, 140], [310, 240], [210, 270], [110, 240], [60, 140]];
  ...
  it("ignores null values", () => {
    assert.deepEqual(geometric.polygonBounds([[null, 5], [0, 1], [1, 2], [0, 3]]), [[0, 1], [1, 3]]);
    assert.deepEqual(geometric.polygonBounds([[undefined, 5], [0, 1], [1, 2], [0, 3]]), [[0, 1], [1, 3]]);
    assert.deepEqual(geometric.polygonBounds([[NaN, 5], [0, 1], [1, 2], [0, 3]]), [[0, 1], [1, 3]]);
    assert.deepEqual(geometric.polygonBounds([[5, Infinity], [0, 1], [1, 2], [0, 3]]), [[0, 1], [1, 3]]);
  });
});
